...
public class TeacherAdapter extends FirebaseRecyclerAdapter<TeachersModel,TeacherAdapter.myViewHolder> {
     ...
     * @param options
     */
    public TeacherAdapter(@NonNull FirebaseRecyclerOptions<TeachersModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull TeachersModel model) {
